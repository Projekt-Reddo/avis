        ...
        <div className="px-3 lg:px-32 2xl:px-52 mt-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-2">
                <div className="rounded shadow-xl h-[20rem] max-w-[15rem] border-solid border-2">
                    ...
                    <div className="font-bold ml-3 mb-2">Feature 1</div>
                ...
                <div className="rounded shadow-xl max-w-[15rem] border-solid border-2">
                    ...
                    <div className="font-bold ml-3 mb-2">Feature 2</div>
                    <div className="text-xs ml-3 mr-8 mb-5">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua.
                ...
                <div className="rounded shadow-xl max-w-[15rem] border-solid border-2">
                    ...
                    <div className="font-bold ml-3 mb-2">Feature 3</div>
                    <div className="text-xs ml-3 mr-8 mb-5">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua.
                ...
                <div className="rounded shadow-xl max-w-[15rem] border-solid border-2">
                    ...
                    <div className="font-bold ml-3 mb-2">Feature 4</div>
                    <div className="text-xs ml-3 mr-8 mb-5">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit,
                        sed do eiusmod tempor incididunt ut labore et dolore
                        magna aliqua.
