                ...
                <>
                    ...
                    >
                        {isOpen && (
                            <Menu.Items
                                static
                                className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-[color:var(--element-bg-color)] drop-shadow-lg border-[0.5px] border-[color:var(--border-color)] focus:outline-none"
                            >
                                <div className="py-1">
